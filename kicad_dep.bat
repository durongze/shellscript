...
@rem call :thirdparty_lib_install "%software_dir%" %home_dir%
...
:thirdparty_lib_install
    ...
    pushd %lib_dir%
        ...
        call %auto_install_func% auto_install    "argparse"                "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "clipper2"                "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "compoundfilereader"      "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "delaunator"              "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "dxflib_qcad"             "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "dynamic_bitset"          "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "expected"                "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "fmt"                     "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%  -DFMT_INSTALL=ON"
        call %auto_install_func% auto_install    "bgzip-hpp"               "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "lemon"                   "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "libcontext"              "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "libpopcnt"               "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "magic_enum"              "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "markdown2html"           "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "nanodbc"                 "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "nanosvg"                 "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "other_math"              "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "rectpack2d"              "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "rtree"                   "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "tinyspline_lib"          "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "potrace"                 "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "nlohmann_json"           "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "picosha2"                "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "json_schema_validator"   "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "pegtl"                   "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "3dxware_sdk"             "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "turtle"                  "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
        call %auto_install_func% auto_install    "thread-pool"             "%home_dir%"  "-DCMAKE_BUILD_TYPE=%BuildType%  -A %ArchType%"
    popd
    call :color_text 2f " -------------- thirdparty_lib_install --------------- "
    endlocal
goto :eof
