...
:thirdparty_lib_install
    ...
    pushd %lib_dir%
        ...
        @rem call %auto_install_func% auto_install    "crypto"         "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "crypto51"       "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "crypto55"       "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "zlib"           "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "png"            "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -DPROJECT_IS_TOP_LEVEL=ON  -A Win32"
        @rem call %auto_install_func% auto_install    "LibJpeg"        "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "CxImage"        "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "id3lib"         "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "json"           "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "ResizableLib"   "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "sqlite3"        "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "TinyXml"        "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "ATL_Server"     "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "WTL91"          "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "WTL91"          "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "updater"          "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "IE2EM"            "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        call %auto_install_func% auto_install    "flag"             "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "Ed2kLoader"       "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
        @rem call %auto_install_func% auto_install    "CrashReporter"    "%home_dir%"  "-DCMAKE_BUILD_TYPE=Release  -A Win32"
    popd
goto :eof
