...
mkdir macros
xcopy %CMAKE_CURRENT_SOURCE_DIR%\macros   .\macros
%PERL%    %pl_file%   %CMAKE_CURRENT_SOURCE_DIR%/version.mac    %CMAKE_CURRENT_SOURCE_DIR%/macros/*.mac    %CMAKE_CURRENT_SOURCE_DIR%/output/*.mac  
popd
